...
;; Font configuration
(set-face-attribute 'default nil :height abuss/default-font-size)
;; Set the fixed pitch face
(set-face-attribute 'fixed-pitch nil :height abuss/default-font-size)
;; Set the variable pitch face
(set-face-attribute 'variable-pitch nil :height abuss/default-variable-font-size :weight 'regular)
